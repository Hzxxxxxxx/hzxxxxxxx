...
function Post(props) {
  ...
  const title = `${props.title} // Zixiang He`
  const description = props.description || ''
  const url = `https://Hzxxxxxxx.com/${props.slug}`
  const date = new Date(props.date).toISOString()
  const image = props.image
    ? `https://Hzxxxxxxx.com${props.image}`
    : 'https://Hzxxxxxxx.com/static/images/home-opt.jpg'
